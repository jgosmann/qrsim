classdef TaskPlumeMultiHeliMultiSourceGaussianDispersionDefaultControls<Task
    % Plume mapping task in which several helicopters are used for the sampling,
    % their dynamics is stochastic and affected by wind disturbances (following a wind model),
    ...
    %
    % TaskPlumeMultiHeliMultiSourceGaussianDispersionDefaultControls methods:
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskPlumeMultiHeliMultiSourceGaussianDispersionDefaultControls(state)
            obj = obj@Task(state);
        end
        ...
        function r=reward(obj)
            ...
            assert(~isempty(obj.receivedSamples),'TaskPlumeSingleSourceGaussianDispersionDefaultControls:nosamples',...
