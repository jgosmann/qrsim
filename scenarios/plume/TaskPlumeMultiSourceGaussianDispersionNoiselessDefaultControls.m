classdef TaskPlumeMultiSourceGaussianDispersionNoiselessDefaultControls<Task
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskPlumeMultiSourceGaussianDispersionNoiselessDefaultControls(state)
            obj = obj@Task(state);
        end
