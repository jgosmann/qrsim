classdef TaskPlumeSingleSourceGaussianDispersionNoiselessDefaultControls<Task
    ...
    % model.
    %
    % TaskPlumeSingleSourceGaussianDispersionNoiselessDefaultControls methods:
    ...
    methods (Sealed,Access=public)
        ...
        function obj = TaskPlumeSingleSourceGaussianDispersionNoiselessDefaultControls(state)
            obj = obj@Task(state);
        end
